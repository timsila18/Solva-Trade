...
const ownerReportCards = [
  ...
  {
    question: "Which customers make profit?",
    report: "Profit by Customer Report",
    category: "Sales",
    description: "Shows revenue, FIFO stock cost, gross profit and margin for each customer.",
    icon: TrendingUp,
  },
  {
    question: "Which supplier/source gives margin?",
    report: "Profit by Supplier and Source Report",
    category: "Sales",
    description: "Separates profit by direct supplier, local market, spot purchase and named supplier.",
    icon: PackageSearch,
  },
  {
...
const periodGroups = [
  ...
  },
  {
    ...
    documents: [
      ...
      ["Sales", "Weekly Sales Activity Report"],
      ["Sales", "Weekly Sales Call Report"],
      ["Sales", "Weekly Route Sales Report"],
      ["Sales", "Deal Loss Reasons Report"],
      ["Customers", "Customer Aging Report"],
  ...
  },
  {
    ...
    documents: [
      ...
      ["Sales", "Monthly Retail Sales Summary Report"],
      ["Sales", "Monthly Sales Report Dashboard"],
      ["Sales", "Sales Tracking Report"],
      ["Sales", "Profit by Customer Report"],
      ["Sales", "Profit by Supplier and Source Report"],
      ["Inventory", "Monthly Inventory Report"],
      ["Inventory", "Inventory Sales Report"],
      ["Finance", "Monthly Expense Report"],
      ["Finance", "Expense Analysis Report"],
      ["Finance", "Profit and Loss Report"],
      ["Finance", "Balance Sheet"],
      ["Finance", "Trial Balance Report"],
  ...
  },
  {
    ...
    documents: [
      ...
      ["Sales", "Quarterly Sales Report"],
      ["Sales", "Annual Sales Performance Report"],
      ["Sales", "Year-End Sales Report"],
      ["Inventory", "Annual Inventory Report"],
      ["Finance", "Annual Expense Report"],
