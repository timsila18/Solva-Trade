      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_320px]">
        <section className="rounded-lg border border-slate-200 bg-white p-5">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <button className="rounded-md border border-slate-200 px-4 py-2 text-sm font-semibold">Preview</button>
            <button className="rounded-md bg-emerald-700 px-4 py-2 text-sm font-semibold text-white">Generate</button>
          </div>
        </section>
