...
<body>
  <main class="page template-${template} emphasis-${style.emphasis}${dailyDocument ? " daily-document" : ""}${catalogueDocument ? " catalogue-document" : ""}" style="--doc-accent: ${style.accent}; --doc-soft: ${style.soft};">
    ...
    ${plainInvoice ? "" : `<footer>
      ${catalogueDocument
        ? `${htmlEscape(report.businessName)} document generated by Solva Trade. ${htmlEscape(style.footerNote)} Printed by ${htmlEscape(report.generatedBy)} on ${htmlEscape(report.generatedAt)}.`
